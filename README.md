...
> **Transparency:** This site was built via human and AI collaboration (ChatGPT and Cursor). See [`Docs_transparency/`](Docs_transparency/) for prompts and content used during initial site establishment.
