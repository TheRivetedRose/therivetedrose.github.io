...
// Colored SVGs with brand colors embedded (C++ #00599C, HTML5 #E34F26, JS #F7DF1E, PostgreSQL #4169E1)
...
const HTML5_SVG = `<svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><title>HTML5</title><path fill="#E34F26" d="${siHtml5.path}"/></svg>`;
...
const POSTGRESQL_SVG = `<svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><title>PostgreSQL</title><path fill="#4169E1" d="${siPostgresql.path}"/></svg>`;
...
export const languages = [
  ...
  { name: "PL/SQL", icon: { svg: POSTGRESQL_SVG } },
] as const;
